...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bruno Silva", "silvas1@gmail.com", new DateTime (1984, 7, 17), 1000.0, d1);
            Seller s2 = new Seller(2, "Carina Buzato", "cabuzato@gmail.com", new DateTime(1987, 12, 28), 3500.0, d2);
            Seller s3 = new Seller(3, "Maria Eduarda", "duda@gmail.com", new DateTime(2002, 5, 22), 2300.0, d1);
            Seller s4 = new Seller(4, "Esthela Buzato", "Buzato@gmail.com", new DateTime(2012, 5, 14), 1000.0, d4);
            Seller s5 = new Seller(5, "Jorge Tadeu", "tadeu@gmail.com", new DateTime(1981, 6, 17), 7000.0, d3);
            Seller s6 = new Seller(6, "Marcos Linq", "linq@gmail.com", new DateTime(1946, 2, 22), 5000.0, d2);
